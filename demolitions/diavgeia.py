...
# μόνο η ονομαστική/γενική «ΚΑΤΕΔΑΦΙΣΗ(Σ)» = πραγματική κατεδάφιση κτίσματος·
# κλιτοί τύποι όπως «ΚΑΤΕΔΑΦΙΣΕΩΝ» εμφανίζονται σε άσχετα έργα (π.χ. μονάδα
# διαχείρισης αποβλήτων κατεδαφίσεων) και ΔΕΝ πρέπει να μετρηθούν
